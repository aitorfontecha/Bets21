...
public class EmaitzaIpiniGUI extends JFrame {
	...
	private final JButton buttonGorde = new JButton(ResourceBundle.getBundle("Etiquetas").getString("EmaitzaIpiniGUI.btnNewButton.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit() throws Exception {
		...
		jComboBoxPronostikoak.setBounds(275, 235, 209, 27);
		...
		lblNewLabel.setBounds(91, 239, 153, 16);
